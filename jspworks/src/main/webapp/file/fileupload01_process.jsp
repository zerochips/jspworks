...
<%
	...
	// 서버에 업로드된 파일 폴더 경로 // 업로드 폴더 경로('\\' or '/' 가능함)
	...
	while(params.hasMoreElements()){
		...
		String value = multi.getParameter(name);	// name 속성을 매개로 값을 할당함
	...
	while(files.hasMoreElements()){
		...
		String fileName = multi.getFilesystemName(name);	// 서버에 업로드할 파일 이름// name을 매개변수로 받아서 파일을 저장
